...
| 9 | Nazar Nurzhankyzy (BDA-2409) | W6 Calibration Engineer: Contributing in code review, has the role of W6 included in the Final Part of the project |
...
│   └── main.py               # CLI entry point (--w3, --w4, --w5)
│
├── data/
