...
% =========================================================
% Safe figure helper (renders if file exists, placeholder otherwise)
% =========================================================
\newcommand{\safefig}[3]{%
  \IfFileExists{#1}{%
    \begin{figure}[H]
    ...
    \begin{figure}[H]
      \centering
      \fbox{\parbox{0.92\textwidth}{\centering\textit{Figure not yet generated. Run \texttt{python main.py -{}-w6} to produce \texttt{\detokenize{#1}}.}}}
...
\begin{titlepage}
    \centering
    \vspace*{3cm}
    {\Huge \textbf{Calibration of Merton and Kou Jump-Diffusion Models to QQQ} \par}
    \vspace{1.5cm}
    {\large Stochastic Processes --- Final Group Project --- Workstream 6 \par}
    \vspace{2cm}
    {\Large Group 3 \par}
    \vspace{0.6cm}
    {\large Workstream 6: Calibration Engineer \par}
    \vspace{0.4cm}
    {\large Nazar Nurzhankyzy (BDA-2409) \par}
    \vspace{2cm}
    {\large June 2026 \par}
    \vfill
\end{titlepage}
...
information criterion penalises Kou for its additional parameter and
favours Merton (AIC $= -3612.02$ vs $-3610.96$).
...
\bibitem{AndersenBenzoniLund2002}
Andersen, T. G., Benzoni, L., \& Lund, J. (2002).
An empirical investigation of continuous-time equity return models.
\emph{Journal of Finance}, 57(3), 1239--1284.

\bibitem{ErakerJohannesPolson2003}
Eraker, B., Johannes, M., \& Polson, N. (2003).
The impact of jumps in volatility and returns.
\emph{Journal of Finance}, 58(3), 1269--1300.

\bibitem{BackusChernovMartin2011}
Backus, D., Chernov, M., \& Martin, I. (2011).
Disasters implied by equity index options.
\emph{Journal of Finance}, 66(6), 1969--2012.

\bibitem{Pan2002}
Pan, J. (2002).
The jump-risk premia implicit in options: Evidence from an integrated time-series study.
\emph{Journal of Financial Economics}, 63(1), 3--50.

\bibitem{BollerslevTodorov2011}
